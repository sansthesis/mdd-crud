...
public class MDDGeneratorMojo extends AbstractMojo {
  ...
  public void execute() throws MojoExecutionException {
    ...
    final List<Emitter> emitters = Arrays.asList(new Emitter[] { new GeneratedDaoEmitter(), new GeneratedResourceEmitter(), new GeneratedResourceImplEmitter(), new GeneratedServiceEmitter() });
