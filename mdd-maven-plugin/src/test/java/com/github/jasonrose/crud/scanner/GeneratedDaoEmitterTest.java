...
public class GeneratedDaoEmitterTest {

  @Test
  public void testGenerateModel() throws Exception {
    final GeneratedDaoEmitter emitter = new GeneratedDaoEmitter();
    ...
    Assert.assertEquals("com.github.jasonrose.crud.om.generated.GeneratedPersonDao", out.getFilename());
    final String verify = CharStreams.toString(Resources.newReaderSupplier(Thread.currentThread().getContextClassLoader().getResource("GeneratedPersonDao.java"), Charsets.UTF_8));
